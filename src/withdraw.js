...
export default function Withdraw(){
    ...
    async function submitHandler(e){    
        ...
        if(isNaN(withdraw) || withdraw < 0){
            ...
            await axios.put(`https://server-0pwt.onrender.com/update/${id}`,{amount:total-withdraw}).then( setTotal(total - withdraw)).then(alert(`amount ${withdraw} is withdrawn successfully !`));
        }
    }
